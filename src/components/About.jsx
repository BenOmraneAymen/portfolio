  ...
  return (
    <div className="flex flex-col justify-center items-center pt-20" id="About">
      ...
      <div className="flex flex-col xl:flex-row  justify-around items-center my-10 ">
        <Reveal>
          <img src={portrait} alt="" className="w-80 h-80 md:w-96 md:h-96 rounded-2xl mb-4 " />
        </Reveal>
        <div className="flex flex-col items-center lg:ml-10 ">
          ...
          <div className="w-96 sm:w-160 md:w-200 pl-4 py-2">
            My name is Aymen Ben Omrane, I'm a Software Engineering Student and
            a Web Instructor in Microsoft Issat Sousse club in Tunisia. I am
            someone who's highly motivated, I always seek to improve myself
            every day and learn many things. I'm thirsty to learn any new
            technology related to the programming or web development field, and
            because I like to keep my horizon always open to new things.
